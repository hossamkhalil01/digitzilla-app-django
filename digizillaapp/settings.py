"""
Django settings for digizillaapp project.
...
SECRET_KEY = 'django-insecure-$@x-+5g-_9%elx+t^$%nnrhi6+e*0)7l3h3#33h^l+a+68=$1i'
...
ROOT_URLCONF = 'digizillaapp.urls'
...
WSGI_APPLICATION = 'digizillaapp.wsgi.application'
